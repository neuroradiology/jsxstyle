...
type Compilation = import('webpack').compilation.Compilation;
...
declare module 'webpack' {
  interface Compiler {
    ...
    watchFileSystem: import('webpack').InputFileSystem;
  }
}

class JsxstyleWebpackPlugin implements WebpackPlugin {
  constructor() {
